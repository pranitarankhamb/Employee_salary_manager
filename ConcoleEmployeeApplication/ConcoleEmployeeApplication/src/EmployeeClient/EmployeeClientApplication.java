...
import EmployeeService.AdminService;
import EmployeeService.AttendenceService;
import EmployeeService.DepartmentService;
import EmployeeService.EmployeeService;
import EmployeeService.SalaryService;
	...
	public static void main(String[] args) {
		...
		int choice;
			...
			do {
				...
				System.out.println("Case 7:Show Employee salary by name or id ");
				...
				case 2:					//Nested switch case
					...
					do {
						...
						System.out.println("press 'e' for exit from employee department");
